...
public class GetSpaceMarineFromKeyboard {
    public static SpaceMarine getSpaceMarineFromKeyboard() {
        System.out.println("Внимание! Поля не могут содержать символ ';'");
        return new SpaceMarine(getName(), getCoordinates(), getHealth(), getCategory(), getWeaponType(), getMeleeWeapon(), getChapter());
    }
    ...
    private static Chapter getChapter() {
        ...
        return new Chapter(chapterName, parentLegion, marinesCount);
    }
}
